...
<form method="POST" action="{{route('product.update',[$product])}}" enctype="multipart/form-data">
    <div class="mb-4 shadow-lg mx-4 card bg-white max-w-md p-10 mt-12 md:rounded-lg mx-auto">
        <div class="title">
            <h1 class="font-bold text-center">Edit Product</h1>
        </div>
        <div class="form mt-4">
            ...
            <div class="mb-4 flex flex-col text-sm">
                ...
                name="description" cols="30" rows="10">{{ old('product_description', $product->description) }}</textarea>
            </div>
            ...
            <div class="mb-4 flex flex-col text-sm">
                ...
                <input class="shadow-md appearance-none border border-gray-200 p-2 focus:outline-none focus:border-gray-500"
                type="text" name="discount_price" value="{{ old('product_discount_price', $product->discount_price) }}">
            </div>
