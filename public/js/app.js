...
if (document.querySelector('#add-variation')) {
  document.querySelector('#add-variation').addEventListener('click', function () {
    axios.post(createPizzaVariation, {}).then(function (response) {
...
__webpack_require__(/*! C:\xampp\htdocs\pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\pizza\resources\css\app.css */"./resources/css/app.css");
